...
library(pastecs)
stat.desc(training_data$f07)
stat.desc(training_data$f32)
stat.desc(training_data$f08)
stat.desc(training_data$f16)
stat.desc(training_data$f44)
stat.desc(training_data$f36)
stat.desc(training_data$f31)
stat.desc(training_data$f43)
stat.desc(training_data$f47)
stat.desc(training_data$f29)